...
options = ["Rock", "Paper", "Scissors"] #Table of options for the game

player = False #sets player to False

print("You can type stop to terminate the program")#The program can be stopped by User inputing stop.
...
while player == False: #While loop will take place as long as player is False
    ...
    elif player == "Paper": #Player having picked Paper
    ...
    elif player == "stop": break #if the player picked stop the program will stop at this point
